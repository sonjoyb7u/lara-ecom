                            ...
                            <div class="row">
                                <div class="col-xs-6 col-md-3">
                                    <a href="images/helsinki-lg.jpg') }}" title="By John Doe">
                                        <img alt="first photo" src="{{ asset('assets/admin/images/helsinki.jpg') }}" class="img-responsive">
                                    </a>
                                </div>
                                <div class="col-xs-6 col-md-3">
                                    <a href="images/helsinki-lg.jpg') }}" title="By John Doe">
                                        <img alt="second photo" src="{{ asset('assets/admin/images/helsinki.jpg') }}" class="img-responsive">
                                    </a>
                                </div>
                                <div class="col-xs-6 col-md-3">
                                    <a href="images/helsinki-lg.jpg') }}" title="By John Doe">
                                        <img alt="third photo" src="{{ asset('assets/admin/images/helsinki.jpg') }}" class="img-responsive">
                                    </a>
                                </div>
                                <div class="col-xs-6 col-md-3">
                                    <a href="images/helsinki-lg.jpg') }}" title="By John Doe">
                                        <img alt="fourth photo" src="{{ asset('assets/admin/images/helsinki.jpg') }}" class="img-responsive">
                                    </a>
                                </div>
                                <div class="col-xs-6 col-md-3">
                                    <a href="images/helsinki-lg.jpg') }}" title="By John Doe">
                                        <img alt="fifth photo" src="{{ asset('assets/admin/images/helsinki.jpg') }}" class="img-responsive">
                                    </a>
                                </div>
                                <div class="col-xs-6 col-md-3">
                                    <a href="images/helsinki-lg.jpg') }}" title="By John Doe">
                                        <img alt="sixth photo" src="{{ asset('assets/admin/images/helsinki.jpg') }}" class="img-responsive">
                                    </a>
                                </div>
                                <div class="col-xs-6 col-md-3">
                                    <a href="images/helsinki-lg.jpg') }}" title="By John Doe">
                                        <img alt="seventh photo" src="{{ asset('assets/admin/images/helsinki.jpg') }}" class="img-responsive">
                                    </a>
                                </div>
                                <div class="col-xs-6 col-md-3">
                                    <a href="images/helsinki-lg.jpg') }}" title="By John Doe">
                                        <img alt="eighth photo" src="{{ asset('assets/admin/images/helsinki.jpg') }}" class="img-responsive">
                                    </a>
                                </div>
                            </div>
                        </div>
