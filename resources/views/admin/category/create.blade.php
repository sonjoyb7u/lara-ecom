            ...
            <div class="col-sm-6 col-lg-6 col-md-offset-3">
                ...
                <div class="panel b-primary bt-md">
                    <div class="panel-content">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <form class="form-horizontal" action="{{ auth()->user()->is_admin === 1 ? route('super-admin.category.store', base64_encode(auth()->user()->id)) : route('admin.category.store', base64_encode(auth()->user()->id)) }}" method="POST">
                                    @csrf
