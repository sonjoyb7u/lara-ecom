...
<head>
    ...
    <link href="{{ asset('assets/admin/vendor/summer-note-textarea/dist/summernote.min.css') }}" rel="stylesheet">
    <!--Date picker-->
...
<script src="{{ asset('assets/admin/vendor/summer-note-textarea/dist/summernote.min.js') }}"></script>
<!--Date picker-->
