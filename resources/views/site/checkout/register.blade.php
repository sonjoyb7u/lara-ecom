...
<div class="col-md-6 col-sm-6 col-md-offset-3 sign-in-page">
    <div class="row">
        ...
        <div class="create-new-account">
            ...
            <form class="register-form outer-top-xs" role="form" action="{{ route('site.checkout.register') }}" method="post">
                @csrf
                ...
                <div>
                    <a href="{{ route('site.checkout.login') }}" class="forgot-password">Have an account, Please&nbsp;<span style="color: #59B210;">Login</span></a>
                </div>
            </form>
