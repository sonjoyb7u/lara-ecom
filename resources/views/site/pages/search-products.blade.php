...
@section('title', 'Search Products | Lara-Ecomm')
        ...
        <div class="container">
            <div class="breadcrumb-inner">
                <ul class="list-inline list-unstyled">
                    <li><a href="#">Home</a></li>
                    <li class='{{ request()->is('search/*') ? 'active' : '' }}'><a href="{{ route('site.search.products') }}">Search Products</a></li>
                </ul>
            </div>
            <!-- /.breadcrumb-inner -->
        </div>
...
<div class="col-xs-12 col-sm-12 col-md-9 homebanner-holder">
    ...
    <div id="category" class="category-carousel hidden-xs">
        <div class="item">
            <div class="image"> <img src="{{ asset('uploads/images/search-product-banner/banner-1.jpg') }}" alt="Search Product Banner" class="img-responsive"> </div>
            <div class="container-fluid">
                <div class="caption vertical-top text-left">
                    <div class="big-text" style="color: #59B210; font-size: 50px;"> Search Products </div>
...
{{--                        @if(count($cat_wise_products) > 0)--}}
                        @if(!$all_search_products->isEmpty())
                            @foreach($all_search_products as $product)
                            ...
                            @endforeach
                        @else
                            <h2 class="text-center text-danger">No Product Found! </h2>
                    @endif
                    <!-- /.item -->
                    </div>
                    <!-- /.row -->
            ...
            <div class="tab-pane"  id="list-container">
                <div class="category-product">
                    @if(count($all_search_products) > 0)
{{--                    @if(!$all_search_products->isEmpty())--}}
                        @foreach($all_search_products as $product)
