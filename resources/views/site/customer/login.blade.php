...
@section('title', 'Customer Login | Lara-Ecomm')
        ...
        <div class="container">
            <div class="breadcrumb-inner">
                <ul class="list-inline list-unstyled">
                    ...
                    <li class='{{ request()->is('customer/login') ? 'active' : '' }}'><a href="{{ route('site.customer.login') }}">Customer Login</a></li>
                </ul>
            </div>
            <!-- /.breadcrumb-inner -->
        </div>
            ...
            <div class="sign-in">
                ...
                <form class="register-form outer-top-xs" role="form" action="{{ route('site.customer.login') }}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" name="email" class="form-control unicase-form-control text-input" id="email" value="{{ old('email') }}" placeholder="Enter Valid Email Address">
                    </div>
                    <div class="form-group">
                        <label class="info-title" for="password">Password <span>*</span></label>
                        <input type="password" name="password" class="form-control unicase-form-control text-input" id="password" placeholder="Enter Vaild Password">
                    </div>
                    ...
                    <div>
                        ...
                        <a href="{{ route('site.customer.register') }}" class="forgot-password pull-right">New Register ?&nbsp;<span style="color: #59B210; font-weight: bold;">Click here</span></a>
                    </div>
